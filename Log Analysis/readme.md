...
**Initial Information:**    What is the total size of the HTTP requests sent and received by IP address 188.191.175.166?
...
**Initial Information:**    Which IP address made the most requests to the Apache web server?
